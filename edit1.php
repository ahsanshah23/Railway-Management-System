        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <p>Please fill this form and submit to add train to the database.</p>
                     <form action="addtraindata.php" method="post">
                    ...
                    <select name="Status" required>
                        ...
                        <option value="Notfunctional">Not Functional</option>
                            ...
                            <label>Departure Time: <input name="DepartureTime" type="time" required/></label>
